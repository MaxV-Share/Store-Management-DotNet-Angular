...
namespace App.Models.Migrations
{
    ...
    [Migration("20220326160451_UpdateMultipleLanguagesCommandAndFunction")]
    partial class UpdateMultipleLanguagesCommandAndFunction
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Models.Entities.CommandDetail", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_command_details");

                    b.HasIndex("CommandId")
                        .HasDatabaseName("ix_command_details_command_id");

                    b.HasIndex("Id")
                        .HasDatabaseName("ix_command_details_id");

                    b.HasIndex("LangId")
                        .HasDatabaseName("ix_command_details_lang_id");

                    b.ToTable("command_details", (string)null);
                });
            ...
            modelBuilder.Entity("App.Models.Entities.FunctionDetail", b =>
                {
                    ...
                    b.HasKey("Id")
                        .HasName("pk_function_details");

                    b.HasIndex("FunctionId")
                        .HasDatabaseName("ix_function_details_function_id");

                    b.HasIndex("Id")
                        .HasDatabaseName("ix_function_details_id");

                    b.HasIndex("LangId")
                        .HasDatabaseName("ix_function_details_lang_id");

                    b.ToTable("function_details", (string)null);
                });
            ...
            modelBuilder.Entity("App.Models.Entities.CommandDetail", b =>
                {
                    b.HasOne("App.Models.Entities.Command", "Command")
                        .WithMany("CommandDetail")
                        .HasForeignKey("CommandId")
                        .HasConstraintName("fk_command_details_commands_command_id");

                    b.HasOne("App.Models.Entities.Lang", "Lang")
                        .WithMany()
                        .HasForeignKey("LangId")
                        .HasConstraintName("fk_command_details_langs_lang_id");
            ...
            modelBuilder.Entity("App.Models.Entities.FunctionDetail", b =>
                {
                    ...
                    b.HasOne("App.Models.Entities.Lang", "Lang")
                        .WithMany()
                        .HasForeignKey("LangId")
                        .HasConstraintName("fk_function_details_langs_lang_id");
